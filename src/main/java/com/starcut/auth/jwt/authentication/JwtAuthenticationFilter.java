...
@Deprecated
public class JwtAuthenticationFilter<T extends UserRepositoryI<U>, U extends UserI> extends GenericFilterBean {
	...
	public JwtAuthenticationFilter(JwtAuthorizationProvider provider, T userRepository, RoleProviderI<U> roleProvider)
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			U user = userRepository.findByPrincipal(subject).orElse(null);
